...
const LogoSlide = () => {
  ...
  return (
    <div className="logo-slide">
      ...
      <div className="motto">
        <h2 className="ideas motto-items">WHEN CERTAIN IDEAS ARRIVE, THEY FIND THEIR WAY TO EXPRESS THEMSELVES THROUGH</h2>
        <div className="sign motto-items">
          <span className="fast-flick font-100">U</span><span className="flicker font-100">S.</span>
        </div>
      </div>
    </div>
  )
